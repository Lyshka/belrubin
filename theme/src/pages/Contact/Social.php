...
<div class="flex flex-col xl:gap-7 gap-6 font-bold text-base leading-[20.8px] uppercase">
    <ul class="flex xl:items-center xl:gap-10 gap-6 xl:flex-row flex-col">
    ...
    <a class="hover:text-red group flex items-center gap-2" href="maito:<?= $email; ?>">
        <svg class="flex-shrink-0" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path class="group-hover:stroke-red" d="M1.83203 18.15H20.1654V4.40002H1.83203V18.15Z" stroke="#2C2C2C" stroke-width="1.5" stroke-linejoin="round" />
            <path class="group-hover:stroke-red" d="M1.83203 4.40002L10.9987 11.275L20.1654 4.40002" stroke="#2C2C2C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
